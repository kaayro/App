app.tickets = {
	...
	viewTicket: function(i,transition){
		...
		if(i >= 0 && i < app.tickets.tickets.length){
			...
			$('#ticket header img').attr('src','http://tourindigital.com/partners2_0/modules/tickets/image.php?id=/'+ticket.companyId);//'http://identidadgeek.com/wp-content/uploads/2014/12/mexicana.jpg');
